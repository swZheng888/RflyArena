...
class MavrosOdomConverter:
    ...
    def odom_callback(self, msg):
        ...
        try:
            ...
            # 发布 TF
            t = TransformStamped()
            t.header = odom_enu.header
            t.child_frame_id = odom_enu.child_frame_id
            t.transform.translation.x = odom_enu.pose.pose.position.x
            t.transform.translation.y = odom_enu.pose.pose.position.y
            t.transform.translation.z = odom_enu.pose.pose.position.z
            t.transform.rotation = odom_enu.pose.pose.orientation
