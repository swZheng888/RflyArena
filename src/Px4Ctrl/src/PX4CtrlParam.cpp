...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	read_essential_param(nh, "gain/maxRateR", gain.maxRateR);
	read_essential_param(nh, "gain/maxRateP", gain.maxRateP);
	read_essential_param(nh, "gain/maxRateY", gain.maxRateY);
	...
	read_essential_param(nh, "max_thr", max_thr);
	read_essential_param(nh, "min_thr", min_thr);
